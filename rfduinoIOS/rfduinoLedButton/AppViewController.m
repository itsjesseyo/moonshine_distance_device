...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        [[self navigationItem] setTitle:@"moonshine_distance"];
    }
    return self;
}
...
- (void)didReceive:(NSData *)data
{
    ...
    const uint16_t *value = [data bytes];
//    int len = [data length];
//    NSLog(@"LEN:%d", len);

    NSLog(@"distnace value = %d", value[0]);
    ...
    [label1 setText:[NSString stringWithFormat:@"%d", value[0]]];
